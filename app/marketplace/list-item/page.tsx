      ...
      {step === 1 && (
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Choose an item from your inventory to list on the marketplace.</CardDescription>
          </CardHeader>
          <CardContent>
            {inventoryItems.length === 0 ? (
              <Alert className="mb-4">
                <AlertTitle>No items in your inventory</AlertTitle>
                <AlertDescription>
                  You don't have any items in your inventory yet. Add items to your inventory first, or create a new
